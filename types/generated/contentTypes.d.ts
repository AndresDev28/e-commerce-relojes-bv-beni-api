...
export interface ApiOrderStatusHistoryOrderStatusHistory extends Struct.CollectionTypeSchema {
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order_status_histories: Schema.Attribute.Relation<
      ...
      'api::order-status-history.order-status-history'
    >;
    orderId: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
...
export interface ApiShipmentShipment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::shipment.shipment'> &
      Schema.Attribute.Private;
